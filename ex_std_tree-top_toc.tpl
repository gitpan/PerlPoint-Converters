<!--
  *** This text is included just below the BODY line in all HTML pages
  $Id: ex_std_tree-top_toc.tpl,v 1.3 2000/11/02 19:37:48 lorenz Exp lorenz $
  $Revision: 1.3 $
...
<TR>
  <TD bgcolor="#FFFF99" valign=center WIDTH=20% >
     <a href="http://www.pixel.de"><img src="../images/karawane-50.gif" border=0></a>
  </TD>
...
<TR>
  <TD colspan=3 >
    Next:  <a href="URL_NEXT">TXT_NEXT</a>
     &nbsp;&nbsp;Index: <a href="URL_INDEX">TXT_INDEX</a>
  </td>
</TR>
</TABLE>
<P>
